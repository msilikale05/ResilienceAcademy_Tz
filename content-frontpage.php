...
<!--                                  <div class="<?php echo $col_css ?>">
 -->                                       <!--  <div class="blog-title"> -->
  ...
  <div class="col-md-6">
    ...
    <!-- conference content-->
    <section class="page_section triangle" id="vision"
             style="background-image: url(<?php echo get_bloginfo('template_directory'); ?>/img/backgrounds/vision.jpg)">
        <div class="inner">
            <div class="overlay-top"
                 style="background-image: url(<?php echo get_bloginfo('template_directory'); ?>/img/bgs/tri-blue.svg)"></div>
            <div class="overlay-bot"
                 style="background-image: url(<?php echo get_bloginfo('template_directory'); ?>/img/bgs/tri-white.svg)"></div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                   ...
                   <div class="col-md-6 col-sm-12"">
                        ...
                        <strong>Join the Announcement List</strong></h4>
                        ...
                        <a href="http://us14.campaign-archive1.com/home/?u=b871212546ebe0a91f640e01f&amp;id=207ea034d8" style="text-decoration:underline;">Check out the archive</a></p>
                   </div>
                        <div class="col-md-6 col-sm-12"">
                        <span class="text-center"><i class="fa fa-handshake" style="font-size:32px" aria-hidden="true"></i></span>
                        <h4 class="tc-black mg-sm">
                        <strong>Join the Discussion List</strong></h4>
                        <p class="section-excerpt">
                    ...
                    <div class="row" id="sponder_row">
                        ...
                        <h4 class="tc-black mg-sm">
                        <strong>Sponsorship Opportunities</strong></h4>
                        <p class="section-excerpt">
                        This event is an amazing opportunity to play a vital role in the community around free and open source geospatial technology. To find out more please visit the sponsorship page</p>
                        </div>
                        <div class="col-md-6 col-sm-12"">
...
<div class="gen-section" id="speaker-div">
  ...
  <div class="speaker-box">
    <div class="speaker" >
      ...
      <div class="popup" onclick="myFunction()">Click for details
      <div class="popuptext" id="myPopup">
      <div class="modalDialog">
      <h2>Angela Oduor Lungati</h2>
      <p style="text-align:left; line-height:165%"><strong>Angela Oduor Lungati</strong><br /><br /> who is a technologist, community builder and an open source software advocate who is passionate about building and using appropriate technology tools to create impact in lives of marginalised groups. With over 7 years experience, she currently serves as Director of Community Engagement at Ushahidi, providing support and building programs for Ushahidi’s diverse global community of users and contributors. 
    ...
    <div class="speaker" >
      ...
      <p style="text-align:left; line-height:165%">
        ...
        <br/>
        We have also set up Youthmappers Chapters at the Institute of Rural Development and Planning in Mwanza and Dodoma and conducted mapathons in over 20 universities around the world.<br/> 
        Our mapping is in two phases – firstly online volunteers trace roads and buildings from satellite images via the HOT tasking manager, then volunteers on the ground add names of villages, offices, churches, shops and other points of interest using a free smartphone app Maps.Me and printed fieldpapers. Community groups discuss the annotated fieldpapers with village leaders and then take a picture of them with their phone and email it to their paired volunteer - an advanced remote mapper from anywhere in the world. They then input this information into OpenStreetMap and produce a printable map of the village which they email back. <br/>
        We helped organise the first State of the Map Tanzania, a 3 day mapping training event in Dar es Salaam in December 2017, and a 3 day training event in Mwanza for Open Data Day in March 2018. <br/>
        Our talk will feature an overview of how we have mobilised such a large community of global mappers, the difficulties we have faced and the advice we have for other countries seeking to replicate this crowdsourced mapping model. We will also talk about the challenges faced by field mappers in remote Tanzania and what they can gain by working together with remote mappers from all around the globe to help map their communities and develop their GIS skills.<br/>

        We will also talk about 3 examples of the impact that maps are having on the remote rural communities where are groups are based, namely; <br>
        How maps can help protect girls at risk from FGM <br>
        How maps can help villages acquire Village Land Use Plans and mitigate local land disputes<br/>

        And how maps can show the extreme distances that students have to walk to school and thereby convince potential donors on the need for school hostels 
     </p>
     </div>
     </div>
    </div>
 ...
 <div class="popup" onclick="speakerThree()">Click for details
    ...
    <div class="popup" onclick="speakerFour()">Click for details
